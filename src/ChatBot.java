public class ChatBot {
    ...
    //prints a fact to the console
    public void fact() {
        System.out.println("The Fitnessgram pacer test is a multi-stage aerobic capacity test.");
    }

    //returns another fact when called
    public String otherFact() {
        return "Mount Everest has an elevation of over 29 thousand feet! ";
    }
}
